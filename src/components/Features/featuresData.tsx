...
const featuresData: Feature[] = [
  {
    id: 1,
    icon: (
      <svg width="60" height="60" viewBox="0 0 40 42" className="fill-current">
        <path
          opacity="0.5"
  ...
  },
  {
    ...
    paragraph:
      "Simplify your recruitment process with our Employee Outsourcing services. We provide access to a pool of pre-vetted professionals specializing in data analytics, engineering, and tech roles. Whether you need temporary or long-term talent, we connect you with the right individuals to drive your business forward.",
  },
];
